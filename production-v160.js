...
const transactionMarkerCode=[
 ...
 "    const payload={version:'1.0',available:markers.length>0,markers,accepted:markers.length,rejected,duplicates,source:'T-Bank GetOperationsByCursor',semantics:'executed_operation_time_only',priceIncluded:false,cacheSeconds:300};",
