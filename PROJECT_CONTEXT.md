...
Continue from `progress/2026-09-25-samurai-recording-1731-hierarchy.md` + current `main`. Samsung recording 1000031731 confirmed the 1730 Atlas cascade fix and exposed the last hierarchy/polish issues: duplicate Home history identity, Home source-gate/nav overlap during manual scroll, low-contrast deep verification copy, and native Goal checkboxes. These are corrected in PR #694. Samurai remains the sole Snowball+ reference shell. Next active functional surface: **Report + category + currency drill-down**.
