...
- Active-only world phase clock keeps local dawn/day/sunset/night state fresh while the Living World is mounted, without adding financial meaning or background work when the view is inactive.
...
7. Preserve the accepted deterministic Living World groundwork (runtime state, live time phase, Chronicle and first-sunrise lifecycle), but keep subjective world art/effects secondary to financial-core, data-quality and Samsung/mobile reliability work.
