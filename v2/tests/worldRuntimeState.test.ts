...
// Corrupt persistence must fail closed: it cannot manufacture XP or semantic events.
...
// Quality comes from relative/current analytics and is independent from persistent XP.
