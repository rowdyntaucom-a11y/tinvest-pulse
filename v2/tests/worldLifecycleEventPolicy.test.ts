...
const first = buildFirstSunriseEventPolicy([], {
  timePhase: 'dawn',
  observedAt: '2026-09-13T05:15:00+00:00',
})
...
assert.equal(Object.prototype.hasOwnProperty.call(first ?? {}, 'xp'), false)
assert.equal(Object.prototype.hasOwnProperty.call(first ?? {}, 'portfolioValue'), false)
assert.equal(Object.prototype.hasOwnProperty.call(first ?? {}, 'weather'), false)
assert.equal(Object.prototype.hasOwnProperty.call(first ?? {}, 'animation'), false)

assert.equal(buildFirstSunriseEventPolicy([
  'xp:achievement-1',
  'world:first-sunrise',
], {
  timePhase: 'dawn',
  observedAt: '2026-09-14T05:15:00Z',
}), null)
