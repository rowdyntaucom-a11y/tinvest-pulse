...
const partial = calculateStressScenario(exposures, {
  id: 'partial', label: 'Partial', source: 'test', sourceDate: '2026-01-01',
...
const totalLoss = calculateStressScenario([
  ...
  id: 'total-loss', label: 'Total loss', source: 'test', sourceDate: null,
  shocks: { equity: -1 },
})
...
const impossible = calculateStressScenario([
  ...
  id: 'impossible', label: 'Impossible', source: 'test', sourceDate: null,
  shocks: { equity: -1.01 },
})
...
const upside = calculateStressScenario([
  ...
  id: 'upside', label: 'Upside', source: 'test', sourceDate: null,
  shocks: { equity: 1.5 },
})
...
const invalidExposure = calculateStressScenario([
  ...
  id: 'invalid-exposure', label: 'Invalid exposure', source: 'test', sourceDate: null,
  shocks: { equity: -0.2 },
})
