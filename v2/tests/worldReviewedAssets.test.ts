...
assert.match(stageSource, /const \{ Application, Assets, Container, Graphics, Sprite \} = await import\('pixi\.js'\)/)
...
assert.match(stageSource, /bindReviewedAssetSprite\([\s\S]*?'background\.distant-settlement'/)
