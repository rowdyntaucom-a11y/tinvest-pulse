export const UI_PREFERENCES_VERSION = '1.0' as const
...
export type UiWorkspace = 'portfolio' | 'analytics' | 'income' | 'dna'
...
const WORKSPACES = new Set<UiWorkspace>(['portfolio', 'analytics', 'income', 'dna'])
