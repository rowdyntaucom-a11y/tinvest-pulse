...
export function AssetWorkspace({
  ...
  const fundamentalsTrust = evaluateFundamentalsTrust({ loading: fundamentalsLoading, ...fundamentals }, trustNow);
  const historyTrust = evaluateAssetHistoryTrust(historyTrustInput, trustNow);
