...
assert.match(app,/loadV3Analysis=\(\)=>import\("\.\.\/analysis\/V3Analysis"\)/);assert.match(app,/V3Analysis=lazy\(loadV3Analysis\)/);
assert.doesNotMatch(app,/import\{V3Analysis\}from/);
assert.match(app,/V3WorkspaceLoading/);assert.match(app,/label="Аналитика"/);
