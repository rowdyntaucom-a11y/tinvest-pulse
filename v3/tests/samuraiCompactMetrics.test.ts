...
assert.ok(main.indexOf("samuraiRitualMotion.css")<main.indexOf("cosmosSignatureSystem.css"));
...
assert.ok(main.indexOf("samuraiRitualMotion.css")<main.indexOf("mobilePerformance.css"));
