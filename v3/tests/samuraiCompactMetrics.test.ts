...
assert.ok(main.indexOf("samuraiAtmosphericSignatures.css")<main.indexOf("samuraiChamberDepth.css"));
assert.ok(main.indexOf("samuraiChamberDepth.css")<main.indexOf("cosmosSignatureSystem.css"));
