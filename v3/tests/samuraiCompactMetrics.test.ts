...
assert.ok(main.indexOf("samuraiOpenCanvas.css")<main.indexOf("cosmosSignatureSystem.css"));
...
assert.ok(main.indexOf("samuraiOpenCanvas.css")<main.indexOf("mobilePerformance.css"));
