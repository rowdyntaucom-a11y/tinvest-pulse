...
assert.match(home,/className="v3-pulse-entry"/);assert.match(home,/disabled={!trusted\|\|demo}/);assert.match(home,/Пульс отключён для демонстрационных данных/);assert.match(home,/>ПУЛЬС<\/button>/);
