...
export const WORLD_EXPLORATION_LANDMARKS:readonly WorldLandmark[]=[
 ...
 {id:'wanderer',label:'Странник',eyebrow:'ТВОЙ СПУТНИК',description:'Странник стоит у главной тропы между мастерской и шахтой. Шляпа, дорожный плащ и меч делают его человеческим якорем сцены, а не декоративной меткой.',x:870,y:652},
