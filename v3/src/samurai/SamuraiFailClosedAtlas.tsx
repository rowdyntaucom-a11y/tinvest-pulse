...
const CHAPTERS:Record<SamuraiFailClosedKind,AtlasChapter[]>={
 ...
 analysis:[
  ...
  {id:"tools",code:"伍",label:"Инструменты",note:"ребаланс · лаборатория · скринер · фьючерсы",detail:"Единый вход в профессиональные read-only инструменты: сценарии ребалансировки, Portfolio Lab, технический discovery, MOEX Screener и фьючерсный WHAT IF.",source:"Каждый инструмент использует собственный проверяемый контракт данных; пользовательские сценарии явно отделены от фактических данных."},
 ],
 income:[
