...
> **Immediate visual task — 2026-09-24:** before resuming the unfinished financial-tab depth sequence, the user wants to establish concept sketches for the remaining shells. This is a short visual-definition pass, not a change to the DNA freeze. NORD is first: Viking + wolf + fjord / northern-light atmosphere, with a colder premium palette and restrained amber. After shell concepts are selected, return to the unfinished financial workspaces.
