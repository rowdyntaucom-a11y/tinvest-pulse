...
Date: 2026-09-23  
Starting main: `5231c1f9` (`feat(v3): give six shells distinct compositions (#573)`).
...
6. `fullShellSystems.css` — final typography, geometry and shell materials.
7. `shellComposition.css` — the authored composition grammar introduced by PR #573.
...
- **Shell:** `shellWorlds.css` owns artwork/global world grading; `fullShellSystems.css` owns typography, geometry, borders, shadows, density and navigation/hero signatures; `shellComposition.css` remains the later owner of the six authored layout grammars from PR #573.
