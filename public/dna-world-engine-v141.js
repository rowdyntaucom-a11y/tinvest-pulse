...
function boot(){
 ...
 art.onload=()=>{artReady=true;art.style.opacity='1';window.dispatchEvent(new CustomEvent('dna-art-ready',{detail:{version:V,width:art.naturalWidth,height:art.naturalHeight,source:'figma-art-rebuild'}}));};
 art.onerror=()=>{artReady=false;art.style.opacity='0';console.warn('DNA local art v'+V+' failed to load');};
 art.src=(window.DNA_ART_PACK&&window.DNA_ART_PACK.sceneBase)||'/assets/dna-world/l1/figma-art-rebuild-v14160.svg?rev=14160';h.appendChild(art);
 ...
 setTimeout(()=>{h.querySelectorAll('.dnBadge').forEach(b=>b.innerHTML='<i></i> ART REBUILD · v'+V+' · 7/11')},120)
}
