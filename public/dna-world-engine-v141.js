...
function boot(){
 ...
 ['dnaWorld148','dnaWorldArt148','dnaQuality14200','dnaEnv14230'].forEach(id=>{const e=document.getElementById(id);if(e)e.remove()});
 let artReady=false;
 ...
 setTimeout(()=>{h.querySelectorAll('.dnBadge').forEach(b=>b.innerHTML='<i></i> CINEMATIC ENV · v'+V+' · 11/11')},120)
}
