...
html = html.replace('</body>', '<script src="/dna-daynight-v113.js?build=1182-label-lock"></script><script src="/dna-market-weather-v114.js?build=1182-label-lock"></script><script src="/dna-weather-alive-v115.js?build=1182-label-lock"></script><script src="/dna-art-detail-v116.js?build=1182-label-lock"></script><script src="/dna-environment-v117.js?build=1182-label-lock"></script><script src="/dna-lights-life-v118.js?build=1182-label-lock"></script></body>');
fs.writeFileSync(htmlPath, html);
process.env.TINVEST_BUILD = '11.8.2';
