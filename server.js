...
// v14.29.0 — DNA WORLD SCALE + LEVEL PREVIEW: global horizon, distant city/bridge and safe 1-11 preview controls; finance/history unchanged.
const legacy = /\s*<script\b[^>]*\bsrc\s*=\s*["'][^"']*\/(?:v840|v850|v860|v870|v960|v1021|version-lock|dna-world-v1021-final|dna-world-v1021-single|dna-game-l1|dna-world-polish-v106|dna-game-art-v107|dna-pixel-v108|dna-pixel-v109|dna-game-world-v110|dna-lighting-v111|dna-cinematic-v112|dna-daynight-v113|dna-market-weather-v114|dna-weather-alive-v115|dna-art-detail-v116|dna-environment-v117|dna-lights-life-v118|dna-foundation-v119|dna-game-quality-v120|dna-characters-depth-v121|dna-character-art-v122|dna-game-art-v123|dna-art-direction-v124|dna-game-art-v125|dna-scene-composition-v126|dna-depth-underground-v127|dna-game-art-v128|dna-character-material-v129|dna-art-reset-v130|dna-scene-composition-v131|dna-material-architecture-v132|dna-art-clarity-v133|dna-character-world-art-v134|dna-scene-hierarchy-v135|dna-visual-story-v136|dna-clean-scene-v137|dna-world-engine-v138|dna-world-engine-v139|dna-world-engine-v140|dna-world-engine-v141|dna-game-assets-v147|dna-art-scene-v148|dna-motion-hotfix-v14170|dna-world-runtime-v14180|dna-level-preview-v14290)\.js(?:\?[^"']*)?["'][^>]*>\s*<\/script>/gi;
html=html.replace(legacy,'').replace(/\s*<script\b[^>]*\bsrc\s*=\s*["'][^"']*\/(?:history-loader-v1191|history-chart-v142)\.js(?:\?[^"']*)?["'][^>]*>\s*<\/script>/gi,'');
const art='<script src="/dna-art-scene-v148.js?rev=14290"></script>',assets='<script src="/dna-game-assets-v147.js?rev=14290"></script>',dna='<script src="/dna-world-engine-v141.js?rev=14290"></script>',runtime='<script src="/dna-world-runtime-v14180.js?rev=14290"></script>',preview='<script src="/dna-level-preview-v14290.js?rev=14290"></script>',history='<script src="/history-chart-v142.js?rev=14290"></script>';
const versionLock=`<script>(function(){const V='v14.29.0';function lock(){document.querySelectorAll('*').forEach(function(el){if(el.children.length)return;const t=el.textContent||'';if(/INVESTOR DNA\\s*·\\s*v\\d+\\.\\d+\\.\\d+/i.test(t))el.textContent=t.replace(/v\\d+\\.\\d+\\.\\d+/i,V);});document.querySelectorAll('.dnBadge').forEach(function(b){const t=b.textContent||'';if(/GAME ASSETS|FOUNDATION WORKS|DNA ART|RESOURCES|MINEWORKS|CLEAN ART|ART REBUILD|DETAIL READABILITY|CINEMATIC ENV|CLEAN POLISH|CHARACTER MATERIAL|WORLD COHESION|MOTION PASS|WORLD SCALE/i.test(t))b.innerHTML='<i></i> WORLD SCALE · '+V+' · 11/11';});}lock();setTimeout(lock,250);setTimeout(lock,1000);})();</script>`;
html=html.replace('</body>',history+art+assets+dna+runtime+preview+versionLock+'</body>');fs.writeFileSync(htmlPath,html);process.env.TINVEST_BUILD='14.29.0';
...
app.get('/api/dna-art/status',(req,res)=>{res.setHeader('Cache-Control','no-store');res.json({ok:true,version:'14.29.0',build:'14.29.0',source:'world-scale',path:'/assets/dna-world/l1/figma-pixel-v14190.svg',overlay:'/assets/dna-world/l1/depth-material-v14210.svg'});});
