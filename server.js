...
app.get('/api/dna-art/status',(req,res)=>{res.setHeader('Cache-Control','no-store');res.json({ok:true,version:'14.15.0',build:'14.15.0',source:'figma-master',path:'/assets/dna-world/l1/figma-master-v14140.svg'});});
